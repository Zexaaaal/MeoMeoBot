const LOG_MESSAGES = {
    ...
    // KICK
    KICK_APP_TOKEN_OK: "App Token Kick obtenu",
    KICK_APP_TOKEN_ERR: "Erreur App Token Kick (status: {status})",
    KICK_APP_TOKEN_FETCH_ERR: "Erreur récupération App Token Kick : {error}",
    KICK_API_NO_TOKEN: "Pas de token Kick disponible pour {endpoint}",
    KICK_API_ERR: "Erreur API Kick : {endpoint} → {status} {body}",
    KICK_API_REQ_ERR: "Erreur requête API Kick : {endpoint} → {error}",
    KICK_SEND_NO_BROADCASTER: "Impossible d'envoyer : broadcaster ID inconnu",
    KICK_NO_WEBHOOK_URL: "Pas d'URL webhook configurée",
    KICK_CHANNEL_FOUND: "Canal Kick trouvé : {channel} (chatroom: {chatroomId})",
    KICK_NO_CHATROOM: "Chatroom introuvable pour {channel}",
    KICK_PUSHER_CONNECTED: "Pusher connecté",
    KICK_PUSHER_DISCONNECTED: "Pusher déconnecté",
    KICK_PUSHER_ERROR: "Erreur Pusher : {error}",
    KICK_SUBSCRIBING: "Abonnement en cours... ({channel})",
    KICK_SUBSCRIBED_CHAT: "Abonné au chat (chatroom: {chatroomId})",
    KICK_SUBSCRIBE_ERR: "Erreur d'abonnement: {error}",
    KICK_PARSE_ERR: "Erreur de parsing Kick: {error}",
    KICK_PUSHER_EVENT: "Événement Pusher reçu: {event}",
    KICK_CONNECT_ERR: "Erreur connexion Kick : {error}",
    KICK_SAY_ERR: "Erreur envoi message Kick : {error}",
    KICK_DISCONNECT_ERR: "Erreur déconnexion Kick : {error}",
    KICK_DISCONNECTED: "Kick déconnecté",
    KICK_RECONNECTING: "Reconnexion Kick en cours...",
    KICK_OFFICIAL_API_FALLBACK: "Fallback API officielle Kick : {error}",
    KICK_NO_CHATROOM_ID: "Pas de chatroom ID pour {slug}",
    KICK_VERIFIER_STORED: "Code verifier PKCE stocké",
    KICK_USER_TOKEN_OK: "Token utilisateur Kick obtenu",
    KICK_TOKEN_EXCHANGE_ERR: "Erreur échange token Kick : {error}",
    KICK_OAUTH_MISSING: "OAuth incomplet : API={hasApi}, Verifier={hasVerifier}",
    KICK_NAPORAOULT_DEL_ERROR: "Erreur suppression commande !naporaoult : {error}",
    KICK_CHANNEL_EMPTY_RESPONSE: "Réponse vide API Kick pour le canal {slug} : {response}",
