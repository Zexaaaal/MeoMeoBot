        ...
        try {
            ...
            results.forEach(result => {
                if (result.status === 'fulfilled' && result.value) {
                    ...
                    logger.error("\x1b[31m%s\x1b[0m", `[ERREUR MINIATURE] ${result.reason}`);
                }
            });
            ...
            logger.error("\x1b[31m%s\x1b[0m", "[ERREUR MAJEURE] dans get-videos:", error);
